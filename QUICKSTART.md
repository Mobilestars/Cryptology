...
2. `python cli.py` ausführen
3. Option 3 (Batch) wählen
4. Dateipfad und Schlüssel eingeben
...
1. **Anfänger**: `python cli.py` ausführen und spielen
...
A: Ja, alle Dateien sind frei verwendbar (Public Domain).
